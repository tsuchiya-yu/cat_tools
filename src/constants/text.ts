...
#猫の年齢計算 #ねこ好きさんと繋がりたい #猫のいる暮らし #ねこツールズ`,
  ...
  CONTENT: {
    ...
    LIFE_STAGE_CARE: {
      ...
      BCS_CRITERIA: [
        'BCS 1〜3（9段階中）：やせ気味（肋骨が触れやすく、腰のくびれが目立つ）',
        'BCS 4〜5（9段階中）：適正（肋骨は触れるが浮き出ず、上から見て適度なくびれ）',
        'BCS 6〜9（9段階中）：太り気味〜肥満（肋骨が触れにくく、腹部脂肪が目立つ）',
      ],
      ITEMS: [
        {
          STAGE: '子猫（0〜1歳）',
    ...
    AVERAGE_LIFESPAN: {
      ...
      NOTE:
        '平均値は調査条件や定義で変動します。性別差は集計方法で差が出るため、このページでは断定せず、環境改善と早期受診を重視します。',
      SOURCES: [
        {
          LABEL: '一般社団法人ペットフード協会: 全国犬猫飼育実態調査（令和6年）',
          URL: 'https://petfood.or.jp/data-chart/',
        },
        {
          LABEL: '一般社団法人ペットフード協会: 調査結果の要約（令和6年, PDF）',
          URL: 'https://petfood.or.jp/pdf/data/2024/2.pdf',
        },
      ],
    },
    DISCLAIMER:
