...
export const CAT_BCS_CHECK_UI_TEXT = {
  ...
  REFERENCE_IMAGE: {
    TITLE: '5段階BCSの参考図',
    DESCRIPTION:
      'BCSは見た目と触診を組み合わせて確認します。下図は一般ユーザー向けの説明用に作成した簡易図で、環境省資料の公式図そのものではありません。詳細な図は環境省の原典をご確認ください。',
    ALT: '猫の5段階BCS（1痩せ〜5肥満）を示す説明用の簡易シルエット図',
    CREDIT:
      '説明図: ねこツールズ作成（環境省「飼い主のためのペットフード・ガイドライン」を参考）',
    SOURCE_LABEL: '環境省「飼い主のためのペットフード・ガイドライン」（PDF）',
    SOURCE_URL:
      'https://www.env.go.jp/nature/dobutsu/aigo/2_data/pamph/petfood_guide_1808/pdf/6.pdf',
    NOTE: '環境省図版の利用条件を最終確認できるまで、原典図の転載は行っていません。',
  },
  PRECHECK: {
    TITLE: 'チェックの前に',
    ITEMS: [
      'これは家庭での観察目安であり、獣医師による診断ではありません',
      '長毛の猫は毛を分け、見た目だけでなく触った感触を確認してください',
      '妊娠中、急な体重変化、食欲低下、明らかな体調不良がある場合は、本ツールより動物病院への相談を優先してください',
      '子猫でもBCS観察はできますが、成長期の給餌量をBCSだけで自己調整しないでください',
      'BCSは主に脂肪のつき方を見る指標であり、筋肉量（MCS）は評価しません',
      '獣医師監修のツールではありません',
    ],
  },
  PALPATION_GUIDE: {
  ...
  SUPPLEMENTARY: {
    ...
    DISCLAIMER:
      '本コンテンツは一般的な情報提供であり、診断・治療を行うものではありません。獣医師監修のツールでもありません。体調不良や判断に迷う症状がある場合は、獣医師の診察を受けてください。',
  },
} as const;
