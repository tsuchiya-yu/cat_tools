...
#猫の年齢計算 #ねこ好きさんと繋がりたい #猫のいる暮らし #ねこツールズ`,
  ...
  CONTENT: {
    CONVERSION: {
      ...
      INTRO:
        '猫の年齢は人間と同じ速さでは進みません。特に子猫期は成長が早く、2歳までに大きく成熟し、その後は比較的ゆるやかに年齢が進みます。このページでは次の式で人間年齢の目安を計算しています。',
      BODY: [
      ...
      NOTE:
        '猫の年齢換算には複数モデル（1歳=17歳/18歳/20歳など）があり、媒体により差があります。大切なのは数字自体より、現在のライフステージに合ったケアへつなげることです。',
    },
    LIFE_STAGE_CARE: {
      TITLE: 'ライフステージ別ケアの要点',
      INTRO:
      ...
      ITEMS: [
        ...
        },
        {
          STAGE: '成熟成猫（7〜10歳）',
          POINTS: [
            '健診：年1回以上、必要に応じ血液・尿・血圧',
            '体重・BCS：体重と筋肉量を同時に観察',
            '食事・運動：関節や歯の状態に合わせて継続',
          ],
        },
        {
          STAGE: 'シニア（11歳〜）',
          POINTS: [
            '健診：年2回を目安',
            '体重・BCS：食欲・飲水・排泄の変化を記録',
            '食事・運動：水分摂取と生活動線をやさしく整える',
          ],
        },
      ],
      LINKS: [
    ...
    AVERAGE_LIFESPAN: {
      TITLE: '猫の平均寿命の目安',
      BODY: [
        '全体平均：約15.79歳（2023年調査）',
        '室内飼育：約16.25歳',
        '屋外に出る猫：約14.18歳',
      ],
      NOTE: [
        '平均値は調査条件や定義で変動します。',
        '性別差は集計方法で差が出るため、このページでは断定せず環境改善と早期受診を重視します。',
      ],
    },
    REFERENCES: {
      TITLE: '参考情報と免責',
      LINKS: [
        {
          LABEL: 'au損保',
          URL: 'https://www.au-sonpo.co.jp/pc/pet-cat/column/post-34.html',
        },
        {
          LABEL: 'tama',
          URL: 'https://www.tamaone.jp/ext/magazine/2025/01/cats-age.html',
        },
        {
          LABEL: 'アイリスオーヤマ',
          URL: 'https://www.irisohyama.co.jp/plusoneday/pet/319',
        },
        {
          LABEL: 'アニコム損保',
          URL: 'https://www.anicom-sompo.co.jp/nekonoshiori/308.html',
        },
        {
          LABEL: 'エネフィブログ',
          URL: 'https://blog.enegene.co.jp/pet_information/cat-age/',
        },
      ],
      DISCLAIMER:
