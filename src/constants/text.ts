      ...
      FACTORS: [
        {
          TITLE: '体重（RER）が土台になる',
          BODY:
            '計算の土台は RER（安静時エネルギー要求量）で、体重から算出します。体重が変わると必要カロリーも連動して変わるため、定期的な体重測定が重要です。',
        },
        {
...
export const CALORIE_FAQ_ITEMS = [
    ...
    {
      question: '減量目標のとき、どれくらいのペースで調整すべき？',
      answer:
        '急に大きく減らさず、まずは現在量から5〜10%程度の小さな調整で始めるのが一般的です。1〜2週間ごとに体重推移を見て、増減を判断してください。',
    },
    {
      question: '去勢/避妊後はどのくらい変わる？',
      answer:
        '成猫では必要カロリーが下がることがあります。まずは去勢/避妊の条件を反映した標準値で開始し、体重の推移に合わせて微調整してください。',
    },
    {
      question: 'おやつはどこまで含めるべき？',
      answer:
        'おやつも1日の総摂取カロリーに含めます。おやつを与える日は、その分だけ主食の量を少し調整すると過剰摂取を防ぎやすくなります。',
    },
] as const;
