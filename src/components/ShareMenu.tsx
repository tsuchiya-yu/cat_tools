...
export default function ShareMenu({ humanAgeYears, humanAgeMonths }: ShareMenuProps) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="share-menu absolute right-0 top-8 -translate-y-1/10 z-20 bg-white border border-gray-200 rounded-xl shadow-lg p-1.5 min-w-[200px]" role="menu" aria-label="共有メニュー">
          {navigator.share && (
            <button
